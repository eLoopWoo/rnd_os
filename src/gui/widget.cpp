...
class Widget
{
    ...
    public:
        ...
        Widget::Widget(Wiget* parent, int32_t x, int32_t y, int32_t w, int32_t h, int8_t r, int8_t g, int8_t b)
        {
            this->parent = parent;
            this->x = x;
            this->y = y;
...
CompositeWidget::CompositeWidget(Wiget* parent, common::int32_t x, common::int32_t y, common::int32_t w, common::int32_t h, common::int8_t r, common::int8_t g, common::int8_t b)
{
    focussedChild = 0;
    numChildren = 0;
}
...
void CompositeWidget::OnMouseMove(int32_t oldx, int32_t oldy, int32_t newx, int32_t )
{
    int firstchild = -1;
    for(int i = 0; i < numChildren; ++i)
    {
